...
function ApiKeyBanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "api-banner flex items-start sm:items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-left", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Open",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-secondary px-1 rounded text-xs", children: "src/frontend/src/lib/pexels.ts" }),
        " ",
        "and replace",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-secondary px-1 rounded text-xs", children: "YOUR_PEXELS_API_KEY" }),
        " ",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, oklch(57% 0.28 295), oklch(84% 0.19 200))",
                    boxShadow: "0 0 12px oklch(57% 0.28 295 / 0.4)"
                  },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-black text-sm", children: "W" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-foreground", children: [
                "WallNova ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "HD" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Browse and download stunning HD and 4K wallpapers powered by Pexels. Free for personal and commercial use." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-3 text-sm", children: "Categories" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: categoryLinks.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: `#${cat.query}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-3 text-sm", children: "About" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-3 leading-relaxed", children: "WallNova HD delivers curated high-resolution wallpapers from Pexels API. Download, save favorites, and discover stunning visuals." }),
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "© ",
                year,
                " WallNova HD. Created by Kush Ranjan"
              ] })
            ]
          }
        )
...
function Hero({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "radial-gradient(ellipse 80% 60% at 50% 0%, oklch(57% 0.28 295 / 0.12) 0%, transparent 70%), oklch(8% 0.01 260)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "linear-gradient(oklch(57% 0.28 295 / 0.04) 1px, transparent 1px), linear-gradient(90deg, oklch(57% 0.28 295 / 0.04) 1px, transparent 1px)",
              backgroundSize: "48px 48px"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-3xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 mb-5 animate-fade-up stagger-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: "✦ Powered by Pexels"
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-4xl sm:text-5xl md:text-6xl leading-tight mb-4 animate-fade-up stagger-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Download " }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-glow", children: "100,000+" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Stunning HD Wallpapers" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-lg mb-8 animate-fade-up stagger-3", children: "Free high-resolution wallpapers for desktop & mobile. Nature, Space, Gaming & more." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-0 rounded-full overflow-hidden border border-border search-input bg-input animate-fade-up stagger-4 max-w-xl mx-auto shadow-elevated", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-1 px-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-center gap-2 animate-fade-up stagger-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
...
function Navbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "navbar-glass sticky top-0 z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 h-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "W" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-lg text-foreground hidden sm:block", children: [
            "WallNova ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "HD" })
          ] })
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 max-w-md mx-auto hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `flex items-center gap-2 rounded-full px-3 py-2 transition-all duration-200 ${focused ? "search-input bg-input border border-neon-cyan/50" : "bg-input border border-border"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4 text-muted-foreground flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
          ...
          navSearch && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-1 ml-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onClick: () => onViewChange("home"),
          className: `hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${currentView === "home" ? "text-foreground bg-secondary" : "text-muted-foreground hover:text-foreground hover:bg-secondary/50"}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${currentView === "favorites" ? "text-neon-pink" : "text-muted-foreground hover:text-foreground hover:bg-secondary/50"}`,
          "data-ocid": "nav.favorites.link",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Heart,
              {
                className: `w-3.5 h-3.5 ${currentView === "favorites" ? "fill-neon-pink" : ""}`,
                style: {
                  color: currentView === "favorites" ? "oklch(68% 0.26 330)" : void 0
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Favorites" }),
            favoritesCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
...
function SkeletonCard({ index: index2 }) {
  const heights = ["200px", "260px", "180px", "300px", "220px", "240px"];
  const h = heights[index2 % heights.length];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "wallpaper-grid-item", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl overflow-hidden border border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton-shimmer w-full", style: { height: h } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton-shimmer h-3 w-3/4 rounded mb-1.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton-shimmer h-2.5 w-1/3 rounded" })
    ] })
  ] }) });
}
function WallpaperCard({
  photo,
  isFavorited: isFavorited2,
  onToggleFavorite,
  onOpen,
  index: index2
}) {
  const handleFavoriteClick = reactExports.useCallback(
    (e) => {
      e.stopPropagation();
  ...
  const handleDownloadClick = reactExports.useCallback(
    async (e) => {
      e.stopPropagation();
      try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", style: { paddingBottom }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: handleDownloadClick,
              className: "download-pill",
              "data-ocid": `gallery.download_button.${index2}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "inline w-3 h-3 mr-1.5" }),
                "Download HD"
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              className: `heart-btn ${isFavorited2 ? "active" : ""}`,
              onClick: handleFavoriteClick,
              "aria-label": isFavorited2 ? "Remove from favorites" : "Add to favorites",
              "data-ocid": `gallery.heart.${index2}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Heart,
                {
                  className: "w-4 h-4",
                  style: {
                    color: isFavorited2 ? "oklch(68% 0.26 330)" : "oklch(72% 0.03 260)",
                    fill: isFavorited2 ? "oklch(68% 0.26 330)" : "transparent"
                  }
                }
              )
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: photo.width >= 3840 ? "4K" : photo.width >= 1920 ? "HD" : "SD"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground font-medium truncate", children: photo.alt || `Photo by ${photo.photographer}` }),
...
function WallpaperGrid({
  ...
  if (loading && photos.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "wallpaper-grid px-4 sm:px-6 max-w-7xl mx-auto", children: Array.from({ length: 12 }).map((_, i) => (
      // biome-ignore lint/suspicious/noArrayIndexKey: skeleton placeholders have no stable IDs
      /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, { index: i }, i)
    )) });
  }
  if (!loading && photos.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-foreground mb-2", children: "No wallpapers found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs", children: emptyMessage })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "wallpaper-grid", children: photos.map((photo, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      WallpaperCard,
      {
        photo,
    ...
    hasMore && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mt-10 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: onLoadMore,
        ...
        onMouseEnter: (e) => {
          e.currentTarget.style.boxShadow = "0 0 20px oklch(57% 0.28 295 / 0.3)";
        },
        onMouseLeave: (e) => {
...
function WallpaperModal({
  ...
  const photoId = photo == null ? void 0 : photo.id;
  reactExports.useEffect(() => {
    setImgLoaded(false);
  }, [photoId]);
  reactExports.useEffect(() => {
  ...
  const handleDownload = reactExports.useCallback(async () => {
    ...
    try {
      ...
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
      ue.success("Wallpaper downloaded!");
    } catch {
      window.open(photo.src.large2x || photo.src.large, "_blank");
      ue.success("Opened in new tab for download");
    } finally {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: "0 0 60px oklch(57% 0.28 295 / 0.2), 0 25px 80px oklch(0 0 0 / 0.7)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onMouseEnter: (e) => {
                  e.currentTarget.style.borderColor = "oklch(84% 0.19 200 / 0.6)";
                },
                onMouseLeave: (e) => {
                  e.currentTarget.style.borderColor = "oklch(22% 0.02 260)";
                },
                "data-ocid": "wallpaper.close_button",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4 text-foreground" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 min-h-0 bg-card", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold text-sm truncate", children: photo.alt || `Photo by ${photo.photographer}` }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: photo.width >= 3840 ? "4K" : photo.width >= 1920 ? "Full HD" : "HD"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      border: `1px solid ${isFavorited2 ? "oklch(68% 0.26 330)" : "oklch(22% 0.02 260)"}`,
                      background: isFavorited2 ? "oklch(68% 0.26 330 / 0.12)" : "transparent",
                      color: isFavorited2 ? "oklch(68% 0.26 330)" : "oklch(72% 0.03 260)"
                    },
                    ...
                    children: [
                      ...
                      isFavorited2 ? "Favorited" : "Favorite"
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      downloading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "w-4 h-4" }),
                      "Download HD"
                    ]
                  }
                )
...
function isFavorited(photo, favorites) {
  return favorites.some((f) => f.id === photo.id);
}
function toggleFavorite(photo, favorites) {
...
function WallNovaApp() {
  ...
  const [navSearch, setNavSearch] = reactExports.useState("");
  reactExports.useRef(null);
  const fetchPhotos = reactExports.useCallback(
    async (query, category, pageNum, append) => {
      return;
    },
    []
  );
  ...
  const handleCategoryChange = reactExports.useCallback((query) => {
  ...
  const handleNavSearchSubmit = reactExports.useCallback((query) => {
    setSearchQuery(query);
    setActiveCategory("");
    setCurrentView("home");
  }, []);
  ...
  const handleToggleFavorite = reactExports.useCallback((photo) => {
    setFavorites((prev) => {
  ...
  const modalFavorited = selectedPhoto ? isFavorited(selectedPhoto, favorites) : false;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ApiKeyBanner, {}),
        ...
        currentView === "favorites" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 pt-10 pb-4 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "My Favorites" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          WallpaperGrid,
          {
            ...
            emptyMessage: currentView === "favorites" ? "You haven't saved any favorites yet. Browse wallpapers and click the heart icon!" : "No wallpapers found. Try a different search term or category."
          }
        ) }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(WallNovaApp, {}) });
}
